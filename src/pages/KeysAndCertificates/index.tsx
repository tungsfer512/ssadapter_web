  ...
  return (
    <>
      <ul className='menu-bar'>
        <li>
          <NavLink to={'/keys-and-certificates/sign-and-auth-key'} activeClassName='active'>SIGN and AUTH
            Keys </NavLink>
        </li>
        <li>
        ...
        <li>
          <NavLink to={'/keys-and-certificates/security-server-tls-key'} activeClassName='active'>Security Server TLS
            Key </NavLink>
        </li>
      </ul>
      <Switch>
        ...
        <Route path="/keys-and-certificates">
          <Redirect to={'/keys-and-certificates/sign-and-auth-key'}/>
        </Route>
      </Switch>
    </>
  );
